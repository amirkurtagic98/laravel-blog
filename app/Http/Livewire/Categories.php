...
class Categories extends Component
{
    ...
    public function resetModalForm() {
        $this->resetErrorBag();
        $this->category_name = $this->subcategory_name = $this->parent_category;
    ...
    public function updateSubcategory() {
        if($this->selected_subcategory_id) {
            $this->validate([
                'parent_category' => 'required',
                'subcategory_name' => 'required|unique:subcategories,subcategory_name,' . $this->selected_category_id
            ]);
