<div>
        ...
        @forelse ($authors as $author)
            <div class="col-md-6 col-lg-3">
                <div class="card">
                    ...
                    <div class="d-flex">
                        <a href="#" class="card-btn" wire:click.prevent="editAuthor({{ $author }})">Edit</a>
    ...
    <div class="row mt-4">
        ...
        {{-- $authors->links('livewire::bootstrap') -> with numbers --}}
    </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div>
                                <label class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="direct-publisher" value="0" wire:model="direct_publisher">
                                    <span class="form-check-label">No</span>
                                </label>
                                <label class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="direct-publisher" value="1" wire:model="direct_publisher">
