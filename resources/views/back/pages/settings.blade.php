        ...
        <div class="card-header">
            <ul class="nav nav-tabs card-header-tabs" data-bs-toggle="tabs" role="tablist">
                <li class="nav-item" role="presentation">
                    <a href="#tabs-general-settings" class="nav-link active" data-bs-toggle="tab" aria-selected="true" role="tab">General Settings</a>
                </li>
                <li class="nav-item" role="presentation">
                    <a href="#tabs-logo-favicons" class="nav-link" data-bs-toggle="tab" aria-selected="false" tabindex="-1" role="tab">Logo & Favicon</a>
                </li>
                <li class="nav-item" role="presentation">
                    <a href="#tabs-social-media" class="nav-link" data-bs-toggle="tab" aria-selected="false" tabindex="-1" role="tab">Social Media</a>
                </li>
            </ul>
        </div>
        <div class="card-body">
            <div class="tab-content">
                <div class="tab-pane fade active show" id="tabs-general-settings" role="tabpanel">
                    <div>
                        @livewire('author-general-settings')
                    </div>
                </div>
                <div class="tab-pane fade" id="tabs-logo-favicons" role="tabpanel">
                    <div>
                        <div class="row">
                            <div class="col-md-6">
                                <h3>Set blog logo</h3>
                                ...
                                <form action="{{ route('author.change-blog-logo') }}" method="post" id="changeBlogLogoForm">
                                    ...
                                    <button class="btn btn-primary" type="submit">Change logo</button>
                                </form>
                            </div>
                            <div class="col-md-6">
                                ...
                                <form action="{{ route('author.change-blog-favicon') }}" method="post" id="changeBlogFaviconForm">
                                    ...
                                    <button class="btn btn-primary" type="submit">Change favicon</button>
                                </form>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="tab-pane fade" id="tabs-social-media" role="tabpanel">
                    <div>
